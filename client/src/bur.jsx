        ...
        <>
            ...
            <div className="main">
                ...
                <div className="diw2">Гуманитарно и социально-экономический цикл
                    <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/bzh" style={{borderRadius: "18px"}}>БЖД</Link>
                            <Link to="/historyru" style={{borderRadius: "18px", marginLeft: "5px"}}>История России</Link>
                            <Link to="/fizra2" style={{borderRadius: "18px", marginLeft: "5px"}}>Физкультура</Link>
                        </div>
                        <div style={{display: "flex"}}>
                            <Link to="/fingram" style={{borderRadius: "18px", marginTop: "5px", padding: "25px 10px 10px 10px"}}>Основы финансовой грамотности</Link>
                            <Link to="/bere" style={{borderRadius: "18px", marginTop: "5px", marginLeft: "5px"}}>Основы бережливого производства</Link>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            ...
                            <Link to="/mathmethods" style={{borderRadius: "18px", marginLeft: "5px"}}>Математические методы решения прикл. проф. задач</Link>
                        </div>
                        <div style={{display: "flex"}}>
                        ...
                        <div style={{display: "flex"}}>
                            <Link to="/priklcomp" style={{borderRadius: "18px", marginTop: "5px", padding: "25px 10px 10px 10px"}}>Прикладные компьютерные программы в профессиональной деятельности</Link>
                            <Link to="/prav" style={{borderRadius: "18px", marginTop: "5px", marginLeft: "5px"}}>Правовые основы профессиональной деятельности</Link>
                        </div>
                        <div style={{display: "flex"}}>
                            <Link to="/ohr" style={{borderRadius: "18px", marginTop: "5px", marginLeft: "5px"}}>Охрана труда</Link>
                            <Link to="/ekol" style={{borderRadius: "18px", marginTop: "5px", marginLeft: "5px"}}>Экологические основы природопользования</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/techbur" style={{borderRadius: "18px", marginLeft: "5px"}}>Технология бурения нефтяных и газовых скважин</Link>
                        </div>
                        <div style={{display: "flex"}}>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/expbur" style={{borderRadius: "18px", marginLeft: "5px"}}>	Эксплуатация бурового оборудования</Link>
                        </div>
                        <div style={{display: "flex"}}>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/osnplan" style={{borderRadius: "18px", marginLeft: "5px"}}>	Основы организации и планирования производственных работ</Link>
                        </div>
                        <div style={{display: "flex"}}>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/expskv" style={{borderRadius: "18px", marginLeft: "5px"}}>	Эксплуатация скважин</Link>
                        </div>
                        <div style={{display: "flex"}}>
                ...
                <div className="dropdown-content">
                        <div style={{display: "flex"}}>
                            <Link to="/caprem" style={{borderRadius: "18px", marginLeft: "5px"}}>	Технология работ по капитальному ремонту скважин</Link>
                        </div>
                        <div style={{display: "flex"}}>
