...
const Proenglish = () => {
    ...
    return (
        <>
            <h2>
            Иностранный язык в проф. деятельности            </h2>
            <p style={{ marginLeft: "350px" }}>
            Все специальности / Бурение нефтяных и газовых скважин / Иностранный язык в проф. деятельности
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Иностранный язык в проф. деятельности</h2>
