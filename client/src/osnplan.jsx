...
const Osnplan = () => {
    ...
    return (
        <>
            <h2>
            Основы организации и планирования производственных работ
            </h2>
            <p style={{ marginLeft: "350px" }}>
                Все специальности / Бурение нефтяных и газовых скважин / Основы организации и планирования производственных работ
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Основы организации и планирования производственных работ</h2>
