...
const Berezh = () => {
    ...
    return (
        <>
            ...
            Все специальности / Бурение нефтяных и газовых скважин / Основы бережливого производства
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Основы бережливого производства</h2>
