...
const Matmethods = () => {
    ...
    return (
        <>
            <h2>
            Математические методы решения прикл. проф. задач
            </h2>
            <p style={{ marginLeft: "350px" }}>
                Все специальности / Бурение нефтяных и газовых скважин / Математические методы решения прикл. проф. задач
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Математические методы решения прикл. проф. задач</h2>
