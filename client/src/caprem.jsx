...
const Caprem = () => {
    ...
    return (
        <>
            <h2>
            Технология работ по капитальному ремонту скважин
            </h2>
            <p style={{ marginLeft: "350px" }}>
                Все специальности / Бурение нефтяных и газовых скважин / Технология работ по капитальному ремонту скважин
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Технология работ по капитальному ремонту скважин</h2>
