    ...
    return (
        <>
            ...
            <p style={{ marginLeft: "350px" }}>
                Все специальности / Бурение нефтяных и газовых скважин / Метрология, стандартизация и сертификация
            </p>
            <div className="div3">
                <Link to="/expgaz">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Метрология, стандартизация и сертификация</h2>
