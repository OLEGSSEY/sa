...
const Inzhen = () => {
    ...
    return (
        <>
            <h2>
            Инженерная графика            </h2>
            <p style={{ marginLeft: "350px" }}>
            Все специальности / Бурение нефтяных и газовых скважин / Инженерная графика
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Инженерная графика</h2>
