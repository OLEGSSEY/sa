...
const Fingramm = () => {
    ...
    return (
        <>
            ...
            Все специальности / Бурение нефтяных и газовых скважин / Основы финансовой грамотности
            </p>
            <div className="div3">
                <Link to="/bur">
            ...
            <div>
                <h2 style={{ marginLeft: "-658px" }}>Раздел Основы финансовой грамотности</h2>
